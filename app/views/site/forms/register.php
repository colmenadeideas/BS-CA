...
<a class="btn btn-lg btn-full btn-facebook more-margin" id="register_with_facebook" onclick="fblogin()"><i class="fa fa-facebook"></i> <?php echo SITE__SIGN_IN_WITH_FACEBOOK; ?></a>
