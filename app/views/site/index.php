...
<div id="mainarea" class="default">
	...
	<section class="container-fluid whatisit nohide" id="site-featured">
		<div class="featured-circles text-center">
			<div class="featured-circle">
				<i class="glyphicon glyphicon-search"></i>
				<h4>Busca <br> al médico</h4>
			</div>
			<div class="featured-circle">
		...
		<div class="col-md-5" style="margin-top:113px;font-weight:300;font-weight: 300;">
			<h2> <span  style="line-height:0;font-weight:300;">LA FORMA MÁS <br></span><span>RÁPIDA Y FÁCIL</span></h2>
			<button class="btn-default btn featured-btn">EMPIEZA AHORA</button>
		</div>
	</section>	
	<section class="container-fluid nohide" id="site-promotion">
		<div class="col-md-6 text-right right" style="margin-top:150px;margin-right:150px;">
			<h2><span style="line-height:0;font-weight:300;">Si eres médico <br></span>
				<span>administra tus <br></span>
				<span style="line-height:0;font-weight:300;">pacientes de la forma más <br></span>
				<span>rápida y fácil</span></h2>
