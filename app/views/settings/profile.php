    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="account-wall">
                <img class="profile-img img-circle img-responsive" src="<?php echo IMG;?>chatuser.png" width="140">
                ...
                <div class="col-md-10 col-md-offset-1">
                        ...
                        <br>
                        <div class="right">
                        <a href="<?php echo URL;?>account/edit/profile" class="btn btn-default disabled"><i class="glyphicon glyphicon-pencil"></i> Editar Perfil</a>
                        <a href="<?php echo URL;?>account/edit/password" class="btn btn-default"><i class="glyphicon glyphicon-lock"></i> Editar Contraseña</a>
                        </div>
                    </div>
