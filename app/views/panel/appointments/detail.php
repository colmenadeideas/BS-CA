						...
						<div class="col-lg-12 col-xs-12 row">
							<?php 
								...
								?>					
									...
									<div class="col-lg-9 col-xs-9  text-left">
										<h2><?php echo $appointment['patient_data'][0]['name'] . " ". $appointment['patient_data'][0]['lastname']; ?></h2>
										<h4><?php echo $appointment['suggested_time_appointment']; ?></h4>
									</div>
