<div class="dates-timeline col-lg-12 col-xs-12">
	<?php 
		...
		<div id="#practices-<?php echo $i."-".$date['date_string']; ?>" class="col-lg-12 col-xs-12 dates-practices">
			<?php foreach ($date['practice'] as $practice) { 
					if (!empty($practice['appointments'])) { ?>
					<!--Practice -->
					<div class="col-lg-2 col-sm-2"></div>
					<div class="col-lg-10 col-xs-10"> <h1><?php echo $practice['name']; ?></h1>						
						...
						<div class="col-lg-12 col-xs-12 row">
							<?php 
								...
								<?php } else { ?>
								<a href="#">
									<div class="col-lg-3 col-xs-3 extra-patients-circle text-center">
										+20
									</div>
								</a>
							<?php 	}?>
